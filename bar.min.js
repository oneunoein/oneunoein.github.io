...
!(function (t) {
    ...
    (e.getMaximumHeightOfEncodings = function (t) {
      ...
      (e.calculateEncodingAttributes = function (t, e, n) {
        for (var r = 0; r < t.length; r++) {
          var i,
            f = t[r],
            l = (0, o.default)(e, f.options);
          i = l.displayValue ? s(f.text, l, n) : 0;
          var c = f.data.length * l.width;
          (f.width = Math.ceil(Math.max(i, c))),
            (f.height = a(f, l)),
            (f.barcodePadding = u(i, c, l));
        }
      }),
  ...
  function (t, e, n) {
    ...
    for (var g in ((p.getModule = function (t) {
      return r.default[t];
    }),
    r.default))
      r.default.hasOwnProperty(g) && v(r.default, g);
    function v(t, e) {
      h.prototype[e] =
        h.prototype[e.toUpperCase()] =
        h.prototype[e.toLowerCase()] =
          function (n, r) {
            var o = this;
    ...
    function y(t, e, n) {
      var r = new e((t = "" + t), n);
      if (!r.valid()) throw new l.InvalidInputException(r.constructor.name, t);
      var a = r.encode();
      a = (0, o.default)(a);
      for (var u = 0; u < a.length; u++)
        a[u].options = (0, i.default)(n, a[u].options);
      return a;
    }
    function b() {
    ...
    function m(t, e, n) {
      ...
      for (var r = 0; r < e.length; r++)
        (e[r].options = (0, i.default)(n, e[r].options)),
    ...
    (h.prototype.options = function (t) {
      return (this._options = (0, i.default)(this._options, t)), this;
    }),
      (h.prototype.blank = function (t) {
      ...
      (h.prototype.init = function () {
        ...
        if (this._renderProperties)
          ...
          this._renderProperties)) {
            ...
            var n = (0, i.default)(this._options, t.options);
      ...
      (h.prototype._defaults = c.default),
      "undefined" != typeof window && (window.JsBarcode = p),
          ...
          return (
            ...
            n.mod43 &&
              (t += (function (t) {
                ...
                (function (t) {
                  for (var e = 0, n = 0; n < t.length; n++) e += l(t[n]);
                  return (e %= 43);
                })(t)
              )),
            (function (t, e) {
          ...
          i(e, [
            {
              key: "encode",
              value: function () {
                for (var t = f("*"), e = 0; e < this.data.length; e++)
                  t += f(this.data[e]) + "0";
                return { data: (t += f("*")), text: this.text };
              },
            },
            {
              key: "valid",
  ...
  function (t, e, n) {
    ...
    function s(t) {
      ...
      if (t && t.getContext)
        return { element: t, renderer: o.default.CanvasRenderer };
      if (t && "object" === (void 0 === t ? "undefined" : r(t)) && !t.nodeName)
        return { element: t, renderer: o.default.ObjectRenderer };
          ...
          },
          {
            ...
            value: function (t, e) {
              var n,
                ...
                o = t.fontOptions + " " + t.fontSize + "px " + t.font;
              t.displayValue &&
                ((r =
                  "top" == t.textPosition
                    ? t.marginTop + t.fontSize - t.textMargin
                ...
                "left" == t.textAlign || e.barcodePadding > 0
                  ? ((n = 0), (i.textAlign = "left"))
                  : "right" == t.textAlign
                  ? ((n = e.width - 1), (i.textAlign = "right"))
                  : ((n = e.width / 2), (i.textAlign = "center")),
                i.fillText(e.text, n, r));
            },
          },
          {
              ...
              value: function (t, e, n) {
                ...
                e.displayValue &&
                  ...
                  "left" == e.textAlign || n.barcodePadding > 0
                    ? ((r = 0), o.setAttribute("text-anchor", "start"))
                    : "right" == e.textAlign
                    ? ((r = n.width - 1), o.setAttribute("text-anchor", "end"))
                    : ((r = n.width / 2),
                      o.setAttribute("text-anchor", "middle")),
                  o.setAttribute("x", r),
                  o.setAttribute("y", i),
                  o.appendChild(this.document.createTextNode(n.text)),
                  t.appendChild(o));
              },
            },
            {
